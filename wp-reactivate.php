...
/**
 * Include File For Register Fishing Spots CPT
 */


include __DIR__ . '/includes/CPTs/fishing-spot.php';
...
include __DIR__ . '/includes/CustomMetaBoxes/fishing-spot-cmb2.php';
